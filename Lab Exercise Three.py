...
#EXERCISE:
# Write a program that: Creates a list of your favorite movies, Lets the user 
#add a new movie. Lets the user remove a movie. And Prints the final sorted list.



# Step 1: Creates a list of favorite movies
movies = ["Inception", "The Matrix", "Interstellar"]

# Step 2: the user adds a new movie
new_movie = input("Enter a movie to add to the list: ")
movies.append(new_movie)

# Step 3: The user removes a movie
...
# Step 4: Prints the final sorted list
movies.sort()
